...
<script>
			...
			var oTable = table
					.dataTable({
						...
						"columns" : [
								{
									"data" : function(data) {
										var html = '<input type="checkbox" name="id" value= '+data.moduleId+'>';
										return html;
									}
								}, {
									"data" : "moduleId"
	...
	function toView() {
		if (isOnlyChecked()) {
			formSubmit('moduleAction_toview.do', '_self');
		} else {
	...
	function toUpdate() {
		if (isOnlyChecked()) {
			formSubmit('moduleAction_toupdate.do', '_self');
		} else {
			alert("请先选择一项并且只能选择一项，再进行操作！");
		}
	}
			...
			<div id="middleMenubar">
				<div id="innerMenubar">
					<div id="navMenubar">
						<ul>
							<li id="view"><a href="#"
								onclick="javascript:toView()">查看</a>
							</li>
							<li id="new"><a href="#"
								onclick="formSubmit('moduleAction_tocreate.do','_self');this.blur();">新增</a>
							</li>
							<li id="update"><a href="#"
								onclick="javascript:toUpdate()">修改</a>
							</li>
							<li id="delete"><a href="#"
								onclick="formSubmit('moduleAction_delete.do','_self');this.blur();">删除</a>
							</li>
						</ul>
					</div>
				</div>
